...
public class ImportDictionaryServlet extends SlingAllMethodsServlet {
    ...
    private void processCsvRecord(Resource dictionaryResource, List<String> languages, List<String> keys, List<List<String>> translations, CSVRecord csvRecord) throws IOException, RepositoryException {
